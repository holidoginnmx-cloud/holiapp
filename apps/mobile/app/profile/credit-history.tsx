...
const styles = StyleSheet.create({
  ...
  headerLabel: { color: COLORS.white, fontSize: 13, fontFamily: "PlusJakartaSans_600SemiBold", opacity: 0.9 },
  headerAmount: { color: COLORS.white, fontSize: 28, fontFamily: "Outfit_600SemiBold", marginTop: 4 },
  row: {
    flexDirection: "row",
    gap: 12,
    alignItems: "center",
  ...
  type: { fontSize: 14, fontFamily: "PlusJakartaSans_700Bold", color: COLORS.textPrimary },
  desc: { fontSize: 12, fontFamily: "PlusJakartaSans_400Regular", color: COLORS.textTertiary, marginTop: 2 },
  date: { fontSize: 11, fontFamily: "PlusJakartaSans_400Regular", color: COLORS.textDisabled, marginTop: 4 },
  amount: { fontSize: 15, fontFamily: "PlusJakartaSans_700Bold" },
