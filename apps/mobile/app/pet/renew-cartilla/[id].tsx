...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontFamily: "Outfit_600SemiBold", color: COLORS.textPrimary },
  subtitle: { fontSize: 16, fontFamily: "PlusJakartaSans_400Regular", color: COLORS.textTertiary, marginTop: 2, marginBottom: 16 },
  reasonBox: {
    flexDirection: "row",
    gap: 10,
    padding: 12,
  ...
  reasonTitle: { fontSize: 14, fontFamily: "PlusJakartaSans_700Bold", marginBottom: 4 },
  reasonItem: { fontSize: 12, fontFamily: "PlusJakartaSans_400Regular", lineHeight: 17 },
  stepsBox: {
  ...
  stepsTitle: { fontSize: 15, fontFamily: "PlusJakartaSans_700Bold", color: COLORS.textPrimary },
  ...
  stepNumberText: { color: COLORS.white, fontSize: 12, fontFamily: "PlusJakartaSans_700Bold" },
  stepText: { flex: 1, fontSize: 14, fontFamily: "PlusJakartaSans_400Regular", color: COLORS.textSecondary, lineHeight: 20 },
  stepTextStrong: { fontFamily: "PlusJakartaSans_700Bold", color: COLORS.textPrimary },
  uploadLabel: { fontSize: 14, fontFamily: "PlusJakartaSans_700Bold", color: COLORS.textSecondary },
  cartillaHelp: {
    fontSize: 13,
  ...
  statusText: { flex: 1, fontSize: 13, fontFamily: "PlusJakartaSans_600SemiBold" },
  detailLink: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "center",
  ...
  detailLinkText: { fontSize: 14, fontFamily: "PlusJakartaSans_700Bold", color: COLORS.primary },
});
