...
export default function AdminReservationLayout() {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen name="guest-bath" options={{ title: "Baño de invitado", headerLeft: backButton }} />
      ...
      <Stack.Screen name="edit-times" options={{ title: "Horario", headerLeft: backButton }} />
