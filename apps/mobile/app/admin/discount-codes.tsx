...
const styles = StyleSheet.create({
  ...
  intro: { fontSize: 13, fontFamily: "PlusJakartaSans_400Regular", color: COLORS.textTertiary, marginBottom: 12, lineHeight: 18 },
  card: { backgroundColor: COLORS.white, borderRadius: 12, padding: 14, marginBottom: 12 },
  formTitle: { fontSize: 16, fontFamily: "PlusJakartaSans_700Bold", color: COLORS.textPrimary, marginBottom: 6 },
  label: {
    fontSize: 14,
  ...
  segmentText: { fontSize: 13, fontFamily: "PlusJakartaSans_700Bold", color: COLORS.textTertiary },
  ...
  cancelBtnText: { color: COLORS.textPrimary, fontFamily: "PlusJakartaSans_700Bold", fontSize: 15 },
  saveBtn: {
    flex: 1,
    paddingVertical: 13,
    borderRadius: 10,
  ...
  saveBtnText: { color: COLORS.white, fontFamily: "PlusJakartaSans_700Bold", fontSize: 15 },
  newBtn: {
    flexDirection: "row",
    gap: 6,
    alignItems: "center",
  ...
  newBtnText: { color: COLORS.white, fontFamily: "PlusJakartaSans_700Bold", fontSize: 15 },
  empty: { textAlign: "center", color: COLORS.textTertiary, marginTop: 24, fontSize: 14, fontFamily: "PlusJakartaSans_400Regular" },
  codeCard: {
    flexDirection: "row",
    alignItems: "center",
    gap: 8,
  ...
  codeText: { fontSize: 16, fontFamily: "PlusJakartaSans_700Bold", color: COLORS.textPrimary },
  inactiveBadge: {
    backgroundColor: COLORS.bgSection,
    paddingHorizontal: 8,
    paddingVertical: 2,
  ...
  codeMeta: { fontSize: 12, fontFamily: "PlusJakartaSans_400Regular", color: COLORS.textTertiary, marginTop: 4 },
  iconBtn: { padding: 4 },
});
