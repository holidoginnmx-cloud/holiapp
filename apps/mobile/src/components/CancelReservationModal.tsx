...
const styles = StyleSheet.create({
  ...
  amountLabel: { fontSize: 12, color: COLORS.textTertiary, fontFamily: "PlusJakartaSans_600SemiBold" },
  amountValue: {
    fontSize: 24,
    fontFamily: "Outfit_600SemiBold",
    color: COLORS.primary,
  ...
  confirmText: { color: COLORS.white, fontSize: 16, fontFamily: "PlusJakartaSans_700Bold" },
  backButton: { alignItems: "center", paddingVertical: 12 },
  backText: { fontSize: 14, fontFamily: "PlusJakartaSans_600SemiBold", color: COLORS.textTertiary },
});
